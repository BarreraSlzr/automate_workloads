...
const PROJECT_STATUS_YML = "fossils/project_status.yml";
...
program
  ...
  .description("Sync master tracker and fossils/project_status.yml with GitHub milestones, issues, and project board")
  .option("--auto-close", "Auto-close issues for checked-off items")
  .option("--sync-tests", "Sync missing tests/fossils from fossils/project_status.yml")
  .action(async (opts) => {
