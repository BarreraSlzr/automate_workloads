...
/**
 * LLM Real-World Scenarios Examples
 * 
...
class LLMRealWorldScenarios {
  ...
  generateScenarioReport(): void {
    console.log('📊 LLM Real-World Scenarios Report');
    console.log('=' .repeat(60));
  ...
  async runAllScenarios(): Promise<void> {
    console.log('🚀 LLM Real-World Scenarios Demo');
    console.log('=' .repeat(60));
...
if (import.meta.main) {
  const demo = new LLMRealWorldScenarios();
  demo.runAllScenarios().catch(console.error);
}

export {
  LLMRealWorldScenarios,
  ScenarioResult
}; 