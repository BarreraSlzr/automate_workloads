...
show_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 -p 123 -m setup barreraslzr automate_workloads"
    echo "  $0 -p 123 -m sync barreraslzr automate_workloads"
    echo "  $0 -p 123 -m report barreraslzr automate_workloads"
}
